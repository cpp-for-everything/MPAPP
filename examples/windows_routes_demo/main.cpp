...
// Part of MPAPP. T-0017 — typed-routing demo (Windows/WinUI 3).
//
// Sibling of gtk4_routes_demo. Same shell + route_table + guards +
// page lifecycle, different per-platform handler set. Same UI shape:
// status labels + 2 switches + 6 typed go_to<> buttons.
...
public:
    void on_launch() override {
        ...
        window_.title  = "MPAPP T-0017 - Typed Routing Demo (WinUI 3)";
        window_.width  = 580;
        window_.height = 720;
...
private:
    ...
    template <class Cb>
    void bind_button(mpapp::button& btn, mpapp::button_handler<wp>& h, const std::string& text,
    ...
    mpapp::label_handler<wp>        route_label_handler_{};
    mpapp::label_handler<wp>        blocked_label_handler_{};
    mpapp::label_handler<wp>        log_label_handler_{};
    mpapp::label_handler<wp>        block_activate_label_handler_{};
    mpapp::label_handler<wp>        form_dirty_label_handler_{};
    mpapp::switch_handler<wp>       block_activate_handler_{};
    mpapp::switch_handler<wp>       form_dirty_handler_{};
    mpapp::button_handler<wp>       btn_home_handler_{};
    mpapp::button_handler<wp>       btn_home_details_handler_{};
    mpapp::button_handler<wp>       btn_settings_handler_{};
    mpapp::button_handler<wp>       btn_settings_profile_handler_{};
    mpapp::button_handler<wp>       btn_help_handler_{};
    mpapp::button_handler<wp>       btn_help_about_handler_{};
