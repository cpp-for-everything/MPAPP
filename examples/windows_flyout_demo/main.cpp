...
// Part of MPAPP. T-0024 — FlyoutPage demo (Windows/WinUI 3).
...
public:
    void on_launch() override {
        ...
        fp_.is_presented = true;

        window_.title  = "MPAPP T-0024 - FlyoutPage Demo (WinUI 3)";
        window_.width  = 720;
        window_.height = 400;
...
private:
    ...
    mpapp::flyout_page_handler<wp>    fp_handler_{};
