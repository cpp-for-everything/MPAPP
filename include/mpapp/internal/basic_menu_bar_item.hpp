...
#ifndef MPAPP_INTERNAL_BASIC_MENU_BAR_ITEM_HPP
#define MPAPP_INTERNAL_BASIC_MENU_BAR_ITEM_HPP
...
class basic_menu_bar_item : public view {
public:
    basic_menu_bar_item() = default;

    basic_menu_bar_item(const basic_menu_bar_item&)            = delete;
    basic_menu_bar_item& operator=(const basic_menu_bar_item&) = delete;
    basic_menu_bar_item(basic_menu_bar_item&&)                 = delete;
    basic_menu_bar_item& operator=(basic_menu_bar_item&&)      = delete;
...
#endif // MPAPP_INTERNAL_BASIC_MENU_BAR_ITEM_HPP
