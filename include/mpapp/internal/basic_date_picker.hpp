...
#ifndef MPAPP_INTERNAL_BASIC_DATE_PICKER_HPP
#define MPAPP_INTERNAL_BASIC_DATE_PICKER_HPP
...
class basic_date_picker : public view {
public:
    basic_date_picker() = default;
...
#endif // MPAPP_INTERNAL_BASIC_DATE_PICKER_HPP
