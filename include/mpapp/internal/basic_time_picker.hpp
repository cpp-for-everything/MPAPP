...
#ifndef MPAPP_INTERNAL_BASIC_TIME_PICKER_HPP
#define MPAPP_INTERNAL_BASIC_TIME_PICKER_HPP
...
class basic_time_picker : public view {
public:
    basic_time_picker() = default;
...
#endif // MPAPP_INTERNAL_BASIC_TIME_PICKER_HPP
