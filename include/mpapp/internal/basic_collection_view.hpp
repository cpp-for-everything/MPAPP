...
#ifndef MPAPP_INTERNAL_BASIC_COLLECTION_VIEW_HPP
#define MPAPP_INTERNAL_BASIC_COLLECTION_VIEW_HPP
...
class basic_collection_view : public view {
public:
    ...
    ~basic_collection_view() override = default;

    basic_collection_view(const basic_collection_view&)            = delete;
    basic_collection_view& operator=(const basic_collection_view&) = delete;
    basic_collection_view(basic_collection_view&&)                 = delete;
    basic_collection_view& operator=(basic_collection_view&&)      = delete;
    ...
    // When set, the basic_collection_view auto-materializes on each change
...
private:
    ...
    // for the lifetime of the basic_collection_view.
    struct items_materialize_cb {
        basic_collection_view* self = nullptr;
...
#endif // MPAPP_INTERNAL_BASIC_COLLECTION_VIEW_HPP
