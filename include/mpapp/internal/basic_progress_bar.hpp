...
#ifndef MPAPP_INTERNAL_BASIC_PROGRESS_BAR_HPP
#define MPAPP_INTERNAL_BASIC_PROGRESS_BAR_HPP
...
class basic_progress_bar : public view {
public:
    basic_progress_bar() = default;
...
#endif // MPAPP_INTERNAL_BASIC_PROGRESS_BAR_HPP
