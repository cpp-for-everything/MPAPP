...
#ifndef MPAPP_INTERNAL_BASIC_FLYOUT_PAGE_HPP
#define MPAPP_INTERNAL_BASIC_FLYOUT_PAGE_HPP
...
class basic_flyout_page : public internal::basic_page {
public:
    basic_flyout_page() = default;
    ~basic_flyout_page() override = default;

    basic_flyout_page(const basic_flyout_page&)            = delete;
    basic_flyout_page& operator=(const basic_flyout_page&) = delete;
    basic_flyout_page(basic_flyout_page&&)                 = delete;
    basic_flyout_page& operator=(basic_flyout_page&&)      = delete;

    // ----- Slots --------------------------------------------------------

    Observable<basic_page*>                  flyout{nullptr};
    Observable<basic_page*>                  detail{nullptr};
...
#endif // MPAPP_INTERNAL_BASIC_FLYOUT_PAGE_HPP
