...
#ifndef MPAPP_INTERNAL_BASIC_MENU_BAR_HPP
#define MPAPP_INTERNAL_BASIC_MENU_BAR_HPP
...
class basic_menu_bar : public view {
public:
    basic_menu_bar() = default;

    basic_menu_bar(const basic_menu_bar&)            = delete;
    basic_menu_bar& operator=(const basic_menu_bar&) = delete;
    basic_menu_bar(basic_menu_bar&&)                 = delete;
    basic_menu_bar& operator=(basic_menu_bar&&)      = delete;
...
#endif // MPAPP_INTERNAL_BASIC_MENU_BAR_HPP
