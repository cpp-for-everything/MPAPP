...
#ifndef MPAPP_INTERNAL_BASIC_SWIPE_VIEW_HPP
#define MPAPP_INTERNAL_BASIC_SWIPE_VIEW_HPP
...
class basic_swipe_view : public view {
public:
    basic_swipe_view() = default;
    ~basic_swipe_view() override = default;

    basic_swipe_view(const basic_swipe_view&)            = delete;
    basic_swipe_view& operator=(const basic_swipe_view&) = delete;
    basic_swipe_view(basic_swipe_view&&)                 = delete;
    basic_swipe_view& operator=(basic_swipe_view&&)      = delete;
...
#endif // MPAPP_INTERNAL_BASIC_SWIPE_VIEW_HPP
