...
#ifndef MPAPP_INTERNAL_BASIC_REFRESH_VIEW_HPP
#define MPAPP_INTERNAL_BASIC_REFRESH_VIEW_HPP
...
class basic_refresh_view : public view {
public:
    basic_refresh_view() = default;
...
#endif // MPAPP_INTERNAL_BASIC_REFRESH_VIEW_HPP
