...
#ifndef MPAPP_INTERNAL_BASIC_GRAPHICS_VIEW_HPP
#define MPAPP_INTERNAL_BASIC_GRAPHICS_VIEW_HPP
...
class basic_graphics_view : public view {
public:
    basic_graphics_view() = default;
    ~basic_graphics_view() override = default;

    basic_graphics_view(const basic_graphics_view&)            = delete;
    basic_graphics_view& operator=(const basic_graphics_view&) = delete;
    basic_graphics_view(basic_graphics_view&&)                 = delete;
    basic_graphics_view& operator=(basic_graphics_view&&)      = delete;
...
#endif // MPAPP_INTERNAL_BASIC_GRAPHICS_VIEW_HPP
