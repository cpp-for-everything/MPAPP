...
#ifndef MPAPP_INTERNAL_BASIC_SWIPE_ITEM_MENU_ITEM_HPP
#define MPAPP_INTERNAL_BASIC_SWIPE_ITEM_MENU_ITEM_HPP
...
class basic_swipe_item_menu_item : public view {
public:
    basic_swipe_item_menu_item() = default;
    ~basic_swipe_item_menu_item() override = default;

    basic_swipe_item_menu_item(const basic_swipe_item_menu_item&)            = delete;
    basic_swipe_item_menu_item& operator=(const basic_swipe_item_menu_item&) = delete;
    basic_swipe_item_menu_item(basic_swipe_item_menu_item&&)                 = delete;
    basic_swipe_item_menu_item& operator=(basic_swipe_item_menu_item&&)      = delete;
...
#endif // MPAPP_INTERNAL_BASIC_SWIPE_ITEM_MENU_ITEM_HPP
