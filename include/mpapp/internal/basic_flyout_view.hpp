...
#ifndef MPAPP_INTERNAL_BASIC_FLYOUT_VIEW_HPP
#define MPAPP_INTERNAL_BASIC_FLYOUT_VIEW_HPP
...
class basic_flyout_view : public view {
public:
    basic_flyout_view() = default;
...
#endif // MPAPP_INTERNAL_BASIC_FLYOUT_VIEW_HPP
