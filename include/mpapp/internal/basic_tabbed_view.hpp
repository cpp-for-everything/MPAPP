...
#ifndef MPAPP_INTERNAL_BASIC_TABBED_VIEW_HPP
#define MPAPP_INTERNAL_BASIC_TABBED_VIEW_HPP
...
class basic_tabbed_view : public view {
public:
    basic_tabbed_view() = default;
...
#endif // MPAPP_INTERNAL_BASIC_TABBED_VIEW_HPP
