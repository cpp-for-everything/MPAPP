...
#ifndef MPAPP_INTERNAL_BASIC_TOOLBAR_HPP
#define MPAPP_INTERNAL_BASIC_TOOLBAR_HPP
...
class basic_toolbar : public view {
public:
    basic_toolbar() = default;
...
#endif // MPAPP_INTERNAL_BASIC_TOOLBAR_HPP
