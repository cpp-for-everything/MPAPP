...
#ifndef MPAPP_INTERNAL_BASIC_TEMPLATED_VIEW_HPP
#define MPAPP_INTERNAL_BASIC_TEMPLATED_VIEW_HPP
...
class basic_templated_view : public view {
public:
    basic_templated_view()                                     = default;
    ~basic_templated_view() override                           = default;
    basic_templated_view(const basic_templated_view&)                = delete;
    basic_templated_view& operator=(const basic_templated_view&)     = delete;
    basic_templated_view(basic_templated_view&&)                     = delete;
    basic_templated_view& operator=(basic_templated_view&&)          = delete;
...
#endif // MPAPP_INTERNAL_BASIC_TEMPLATED_VIEW_HPP
