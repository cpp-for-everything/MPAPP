...
#ifndef MPAPP_INTERNAL_BASIC_TABLE_VIEW_HPP
#define MPAPP_INTERNAL_BASIC_TABLE_VIEW_HPP
...
class basic_table_view : public view {
public:
    basic_table_view() = default;
    ~basic_table_view() override = default;

    basic_table_view(const basic_table_view&)            = delete;
    basic_table_view& operator=(const basic_table_view&) = delete;
    basic_table_view(basic_table_view&&)                 = delete;
    basic_table_view& operator=(basic_table_view&&)      = delete;
...
#endif // MPAPP_INTERNAL_BASIC_TABLE_VIEW_HPP
