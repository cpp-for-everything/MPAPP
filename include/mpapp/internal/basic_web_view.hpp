...
#ifndef MPAPP_INTERNAL_BASIC_WEB_VIEW_HPP
#define MPAPP_INTERNAL_BASIC_WEB_VIEW_HPP
...
class basic_web_view : public view {
public:
    basic_web_view() = default;
    ~basic_web_view() override = default;

    basic_web_view(const basic_web_view&)            = delete;
    basic_web_view& operator=(const basic_web_view&) = delete;
    basic_web_view(basic_web_view&&)                 = delete;
    basic_web_view& operator=(basic_web_view&&)      = delete;
...
#endif // MPAPP_INTERNAL_BASIC_WEB_VIEW_HPP
