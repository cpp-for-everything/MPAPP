...
#ifndef MPAPP_INTERNAL_BASIC_BOX_VIEW_HPP
#define MPAPP_INTERNAL_BASIC_BOX_VIEW_HPP
...
class basic_box_view : public view {
public:
    basic_box_view() = default;
...
#endif // MPAPP_INTERNAL_BASIC_BOX_VIEW_HPP
