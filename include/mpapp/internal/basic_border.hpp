...
#ifndef MPAPP_INTERNAL_BASIC_BORDER_HPP
#define MPAPP_INTERNAL_BASIC_BORDER_HPP
...
class basic_border : public view {
public:
    basic_border() = default;
...
#endif // MPAPP_INTERNAL_BASIC_BORDER_HPP
