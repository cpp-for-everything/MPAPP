...
//
// `mpapp::gyroscope` — angular-velocity sensor. Counterpart to MAUI
// Essentials `Gyroscope`. Abstract interface + an in-memory mock whose
...
#ifndef MPAPP_ESSENTIALS_GYROSCOPE_HPP
#define MPAPP_ESSENTIALS_GYROSCOPE_HPP
...
class mock_gyroscope final : public gyroscope {
public:
    // ---- gyroscope interface ----------------------------------------------
...
#endif // MPAPP_ESSENTIALS_GYROSCOPE_HPP
