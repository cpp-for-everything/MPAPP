...
// mappers for `scroll_view`. The `content` property is recorded as a
...
public:
    ...
    void map_orientation(scroll_view& sv) {
        bind("orientation", sv.orientation, binding_orientation_);
    }

    void map_horizontal_scroll_bar_visibility(scroll_view& sv) {
        bind("horizontal_scroll_bar_visibility",
             sv.horizontal_scroll_bar_visibility,
             binding_h_visibility_);
    }

    void map_vertical_scroll_bar_visibility(scroll_view& sv) {
    ...
    void map_content(scroll_view& sv) {
    ...
    void map_scroll_to(scroll_view& /*sv*/, const scroll_to_request& req) {
