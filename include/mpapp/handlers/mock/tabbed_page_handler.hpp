...
// Part of MPAPP. Mock handler for `mpapp::tabbed_page`.
...
public:
    ...
    void map_lifecycle(tabbed_page& tp) {
...
private:
    ...
    struct kids_recorder {
        self_t* self = nullptr;
        void operator()(const std::vector<page*>& v) const { self->record_change("children.count", v.size()); }
    };
    struct sel_recorder {
        self_t* self = nullptr;
    ...
    signal_slot<const std::vector<page*>&> slot_kids_{};
    signal_slot<const int&>                slot_sel_{};
    signal_slot<page*>                     slot_will_app_{};
    signal_slot<page*>                     slot_did_app_{};
    signal_slot<page*>                     slot_will_dis_{};
    signal_slot<page*>                     slot_did_dis_{};
};
