...
public:
    ...
    void map_vertical_alignment(stack_layout& s) {
    ...
    void map_add(stack_layout& /*s*/, view& /*child*/) { record_event("add"); }
    void map_remove(stack_layout& /*s*/, view& /*child*/) { record_event("remove"); }
    void map_clear(stack_layout& /*s*/) { record_event("clear"); }
