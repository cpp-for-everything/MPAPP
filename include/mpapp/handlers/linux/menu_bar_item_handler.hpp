...
// Part of MPAPP. GTK4 basic_menu_bar_item handler — wraps a `GtkMenuButton`
// whose basic_label is the basic_entry's `title`. A child popover can be attached
// later (when basic_menu_flyout lands in M-04c) by calling
...
// the basic_menu_flyout family arrives.
...
void map_gestures(basic_menu_bar_item& x);
