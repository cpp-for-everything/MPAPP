...
// Part of MPAPP. GTK4 basic_indicator_view handler — renders a row of dots
...
//
// No native basic_page-indicator widget exists in GTK4. The handler rebuilds
...
void map_gestures(basic_indicator_view& x);
