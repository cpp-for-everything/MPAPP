...
// Part of MPAPP. WinUI 3 indicator_view handler — renders a row of dots
// manually using a horizontal `mux::Controls::StackPanel` of
// `mux::Shapes::Ellipse` children.
//
// No native page-indicator widget exists in WinUI 3. The handler rebuilds
