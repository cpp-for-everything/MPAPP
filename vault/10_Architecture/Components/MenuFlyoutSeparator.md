...
To be filled. What does MenuFlyoutSeparator do for the user?

## MAUI Reference

- **Handler:** `D:\GitHub\MPAPP\maui\src\Core\src\Handlers\MenuFlyoutSeparator\`
- **Control:** `D:\GitHub\MPAPP\maui\src\Controls\src\Core\MenuFlyoutSeparator\`
...
class menuflyoutseparator : public control<menuflyoutseparator> {
public:
