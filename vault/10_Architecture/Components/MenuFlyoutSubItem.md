...
To be filled. What does MenuFlyoutSubItem do for the user?

## MAUI Reference

- **Handler:** `D:\GitHub\MPAPP\maui\src\Core\src\Handlers\MenuFlyoutSubItem\`
- **Control:** `D:\GitHub\MPAPP\maui\src\Controls\src\Core\MenuFlyoutSubItem\`
...
class menuflyoutsubitem : public control<menuflyoutsubitem> {
public:
