...
To be filled. What does Element do for the user?

## MAUI Reference

- **Handler:** `D:\GitHub\MPAPP\maui\src\Core\src\Handlers\Element\`
- **Control:** `D:\GitHub\MPAPP\maui\src\Controls\src\Core\Element\`
- **Docs:** [Microsoft .NET MAUI — Element](https://learn.microsoft.com/en-us/dotnet/maui/user-interface/controls/element)
...
class element : public control<element> {
public:
