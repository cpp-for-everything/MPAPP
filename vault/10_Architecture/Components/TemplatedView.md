...
To be filled. What does TemplatedView do for the user?

## MAUI Reference

- **Handler:** `D:\GitHub\MPAPP\maui\src\Core\src\Handlers\TemplatedView\`
...
class templatedview : public control<templatedview> {
public:
