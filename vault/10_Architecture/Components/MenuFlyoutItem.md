...
| Layer | Class | Header |
|---|---|---|
| Surface — platform-agnostic, handler held by pointer | `mpapp::internal::basic_menu_flyout_item` | [`include/mpapp/internal/basic_menu_flyout_item.hpp`](../../../include/mpapp/internal/basic_menu_flyout_item.hpp) |
| Wrapper — user-facing, embeds the platform handler by value | `mpapp::menu_flyout_item` | [`include/mpapp/menu_flyout_item.hpp`](../../../include/mpapp/menu_flyout_item.hpp) |
...
mpapp::internal::basic_menu_flyout_item w;
mpapp::menu_flyout_item_handler<mpapp::platform::mock> h;
// h.map_<property>(w);  // exercise the mapper contract
```

The `mpapp::menu_flyout_item_handler<Platform>` alias (template, defaults to `platform::current`) keeps `mpapp::menu_flyout_item_handler<>` and `mpapp::menu_flyout_item_handler<platform::mock>` valid spellings without naming `internal::`.
