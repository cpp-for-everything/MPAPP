...
- **Handler:** `D:\GitHub\MPAPP\maui\src\Core\src\Handlers\Switch\`
- **Control:** `D:\GitHub\MPAPP\maui\src\Controls\src\Core\Switch\`
...
- Mock tests: `tests/components/switch/mock_test.cpp` (planned)
