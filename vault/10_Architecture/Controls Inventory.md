...
| [[Components/NavigationPage\|NavigationPage]] | `Handlers/NavigationPage/` | mock (page_stack engine per ADR-0014 + sync push/pop/pop_to_root + attached-property store; real handlers pending per-platform landing) |
