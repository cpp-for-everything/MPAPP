...
Java_io_mpapp_MppCheckedChangeListener_nativeDispatchCheckedChanged(
    ...
    switch (kind) {
        case 1:  // switch_handler
            mpapp::internal::android_switch_dispatch_checked_changed(
                reinterpret_cast<mpapp::internal::switch_handler<mpapp::platform::android>*>(handler_ptr),
                v);
            return;
        case 2:  // check_box_handler
            mpapp::internal::android_check_box_dispatch_checked_changed(
                reinterpret_cast<mpapp::internal::check_box_handler<mpapp::platform::android>*>(handler_ptr),
                v);
            return;
        case 3:  // radio_button_handler
            mpapp::internal::android_radio_button_dispatch_checked_changed(
                reinterpret_cast<mpapp::internal::radio_button_handler<mpapp::platform::android>*>(handler_ptr),
                v);
            return;
        case 4:  // switch_cell_handler
            mpapp::internal::android_switch_cell_dispatch_checked_changed(
                reinterpret_cast<mpapp::internal::switch_cell_handler<mpapp::platform::android>*>(handler_ptr),
                v);
            return;
        default:
            return;
