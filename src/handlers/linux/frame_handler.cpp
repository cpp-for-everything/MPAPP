...
// Part of MPAPP. GTK4 basic_frame handler implementation. `mpapp::internal::basic_frame` is the
...
std::string next_frame_class() {
    ...
    return "mpapp-basic_frame-" + std::to_string(counter.fetch_add(1));
}
...
void frame_handler<platform::linux_>::reload_css() {
    ...
    // MAUI Frame draws a 1px basic_border by default.
