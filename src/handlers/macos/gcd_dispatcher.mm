...
// AppKit real main-thread dispatcher implementation (GCD main queue).
//
...
class macos_gcd_dispatcher final : public ::mpapp::dispatcher {
public:
...
void install_macos_main_dispatcher() {
    static ::mpapp::internal::macos_gcd_dispatcher inst;
