...
// WinUI 3 shell handler implementation.
...
void shell_handler<platform::windows>::apply_flyout_content(page* p) {
    if (native_ == nullptr) return;
...
void shell_handler<platform::windows>::apply_current_content(page* p) {
